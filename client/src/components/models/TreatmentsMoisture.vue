                    ...
                    <div class="col-md-4">
                        <div class="form-group mb-4">
                            ...
                            <div class="input-group">
                                <input v-model="moisture" type="text" name="moisture" placeholder="Average Moisture Level" class="form-control">
                            </div>
                            ...
                            <!-- Compare Moisture Level Input -->
                            <div v-if="comparedAttVal === 'moisture'" class="input-group">
                                <input v-model="comparedMoisture" type="text" name="compared_moisture" class="form-control" placeholder="Compared Moisture Value">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2">
